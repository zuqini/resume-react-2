    ...
    return (
        <div className='experience-block'>
            <div className='experience-header'>
                <div className='desc'>
                    <p className='position-title'><a href={href} className='bold-text'>{company}</a> | <span className='position med-text'>{position}</span> <span className='team'>{team ? `- ${team}` : ''}</span></p>
